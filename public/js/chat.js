...
document.addEventListener('DOMContentLoaded', function () {
    ...
    async function createDefaultConversation() {
        try {
            console.log('🔧 Creating default conversation with admin@bookbee.com');
            
            const defaultAdminId = 'eced6570-e240-47fd-ad47-1b6422ac10fe';
            ...
            // Fallback: set admin ID trực tiếp để có thể gửi tin nhắn
            adminId = 'eced6570-e240-47fd-ad47-1b6422ac10fe';
            console.log('⚠️ Using fallback admin ID:', adminId);
