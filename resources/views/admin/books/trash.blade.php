                    ...
                    <div class="card-body">
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="search"
                                            placeholder="Tìm kiếm theo tên hoặc ISBN..." value="{{ request('search') }}">
                                    ...
                                    <tbody>
                                        @foreach ($trashedBooks as $index => $book)
                                            <tr>
                                                ...
                                                <td>{{ $book->authors && $book->authors->count() ? $book->authors->pluck('name')->join(', ') : 'N/A' }}
                                                </td>
                        ...
                        @else
                            <div class="text-center py-5">
                                <img src="{{ asset('assets/images/empty-box.png') }}" alt="Empty" class="img-fluid"
