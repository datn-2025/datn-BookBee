                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input type="number" min="0" class="form-control @error('combo_stock') is-invalid @enderror" id="combo_stock" placeholder="Số lượng combo" name="combo_stock" value="{{ old('combo_stock', $collection->combo_stock) }}">
                                @error('combo_stock')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
