    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-white py-8">
            ...
            <div
                ...
                <div class="bg-black text-white px-8 py-6 relative">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-gray-300 text-sm uppercase tracking-wider">THEO DÕI VÀ QUẢN LÝ TẤT CẢ ĐƠN HÀNG CỦA BẠN
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        @foreach ($statuses as $statusKey => $label)
                           ...
                           {{ request('status', 'all') == $statusKey ? 'border-black text-black bg-white' : 'border-transparent text-gray-500 hover:text-black hover:bg-gray-100' }}">
                                ...
                                @if ($statusKey !== 'all' && isset($orderCounts[$statusKey]) && $orderCounts[$statusKey] > 0)
                                    <span
                                        class="ml-2 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none 
                ...
                <div class="space-y-6">
                                ...
                                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                                    ...
                                    <div class="flex items-center gap-4">
                                        @if ($order->refundRequests->isNotEmpty())
                                            @php
                                                $latestRefund = $order->refundRequests
                                ...
                                @if ($order->isParentOrder())
                                    ...
                                    <div id="child-orders-{{ $order->id }}" class="hidden mb-8">
                                        <div class="flex items-center gap-3 mb-6">
                                            ...
                                            <h4 class="text-base font-bold uppercase tracking-wide text-black">ĐƠN HÀNG CON
                                            </h4>
                                        </div>
                                                    ...
                                                    @if ($childOrder->orderItems->count() > 0)
                                                        <div class="mt-6 border-t border-gray-300 pt-4">
                                                            <h6
                                                                ...
                                                                SẢN PHẨM ({{ $childOrder->orderItems->sum('quantity') }}
                                                                sản
                                                                phẩm)</h6>
                                                            <div class="space-y-6">
                                                                @foreach ($childOrder->orderItems as $item)
                                                                    <div
                                                                        ...
                                                                        @endif
                                                                        <<<<<<< HEAD=======<div class="flex gap-2 mt-3">
                                                                            @if ($review->user_id === auth()->id())
                                                                                <a href="{{ route('account.reviews.edit', $review->id) }}"
                                                                                    class="px-3 py-1 bg-black text-white text-xs font-medium hover:bg-gray-900 transition-colors duration-150">
                                                                                    Sửa đánh giá
                    ...
                    <div class="flex gap-2 mt-4">
                        ...
                        @if (\App\Helpers\OrderStatusHelper::canBeCancelled($childOrder->orderStatus->name))
                            <form action="{{ route('account.orders.cancel', $childOrder->id) }}" method="POST"
                                class="inline">
                                @csrf
                                @method('PUT')
                                <button type="submit"
                    ...
                    <div class="flex justify-between">
                        ...
                        @if ($order->refundRequests->isNotEmpty())
                            ...
                            <span
                                ...
                                @elseif($latestRefund->status === 'processing')
                                    ĐANG XỬ LÝ HOÀN TIỀN
                                @elseif($latestRefund->status === 'completed')
                                    ĐÃ HOÀN TIỀN
                    ...
                    @if ($order->refundRequests->isNotEmpty())
                        ...
                        <div
                            class="mt-4 p-3 border-l-4 
                                            ...
                                            @elseif($latestRefund->status === 'rejected') border-red-500 bg-red-50 @endif">
                            <div class="flex items-center gap-2 mb-2">
                                <div
                                    class="w-1 h-4 
                                                    ...
                                                    @elseif($latestRefund->status === 'rejected') bg-red-500 @endif">
                                </div>
                                <h5
                                    class="font-bold text-xs uppercase tracking-wide 
                                                    ...
                                                    @elseif($latestRefund->status === 'rejected') text-red-800 @endif">
                                    YÊU CẦU HOÀN TIỀN</h5>
                            </div>
                            <div class="space-y-1 text-xs">
                                <p><span class="font-bold">Số tiền:</span>
                                    {{ number_format($latestRefund->amount, 0, ',', '.') }}đ</p>
                                <p><span class="font-bold">Ngày yêu cầu:</span>
                                    {{ $latestRefund->created_at->format('d/m/Y H:i') }}</p>
                                @if ($latestRefund->processed_at)
                                    <p><span class="font-bold">Ngày xử lý:</span>
                                        {{ $latestRefund->processed_at->format('d/m/Y H:i') }}</p>
                                @endif
            ...
            <div>
                ...
                <div class="space-y-2 text-sm">
                    @if ($order->delivery_method === 'pickup')
                        ...
                        <p><span class="font-bold text-black">Số điện thoại:</span> {{ $order->recipient_phone ?? '' }}
                        </p>
                                    ...
                                    @else
                                        @php
                                            ...
                                            if ($item->book && $item->book->cover_image) {
                                                ...
                                                $bookImageUrl = asset(
                                                    'storage/' . $item->book->images->first()->image_url,
                                                );
                                            }
                                        @endphp
                            ...
                            <div class="flex-1">
                                ...
                                @else
                                    ...
                                    @if (
                                        ...
                                        <div class="mb-2">
                                            <div class="flex items-center gap-2 mb-1">
                                                ...
                                                <span class="text-sm font-bold text-red-600 uppercase tracking-wide">Quà
                                                    tặng:</span>
                                            </div>
                                            <div class="space-y-1">
                                                @foreach ($item->book->gifts as $gift)
                                    ...
                                    <div class="flex gap-2 mt-4">
                                        ...
                                        @if (\App\Helpers\OrderStatusHelper::canBeCancelled($childOrder->orderStatus->name))
                                            <form action="{{ route('account.orders.cancel', $childOrder->id) }}"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div>
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-1 h-5 bg-black"></div>
                    <h4 class="text-base font-bold uppercase tracking-wide text-black">THÔNG TIN ĐƠN
                        HÀNG</h4>
                </div>

                @if ($order->delivery_method === 'mixed')
                    <div class="bg-blue-50 border-l-4 border-blue-500 p-3 mb-4">
                        <h5 class="font-bold text-blue-800 text-xs mb-1">📦 ĐƠN HÀNG ĐÃ ĐƯỢC CHIA THÀNH
                            2 PHẦN</h5>
                        <p class="text-xs text-blue-600">Sách vật lý sẽ được giao hàng, ebook sẽ được
                            gửi qua email</p>
                    </div>
                @endif
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between">
                        <span class="text-gray-600 uppercase tracking-wide">Phương thức thanh
                            toán:</span>
                        <span class="font-bold text-black">{{ $order->paymentMethod->name ?? 'Không xác định' }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600 uppercase tracking-wide">Trạng thái thanh
                            toán:</span>
                        @if ($order->refundRequests->isNotEmpty())
                            @php $latestRefund = $order->refundRequests->sortByDesc('created_at')->first(); @endphp
                            <span
                    ...
                    @if ($order->refundRequests->isNotEmpty())
                        ...
                        <div
                            ...
                            <div class="space-y-1 text-xs">
                                ...
                                @endif
                                @if ($latestRefund->admin_note)
                                    <p><span class="font-bold">Ghi chú:</span>
                                        {{ $latestRefund->admin_note }}</p>
                                @endif
                            </div>
                        </div>
                    @endif
            ...
            <div>
                ...
                <div class="space-y-2 text-sm">
                    ...
                    @elseif($order->delivery_method === 'ebook')
                        <p><span class="font-bold text-black">Phương thức:</span> Sách điện tử (Ebook)
                        </p>
                                    ...
                                    @if ($review && !$review->trashed())
                                        <div class="bg-gray-50 border-2 border-gray-200 p-4">
                                            ...
                                            @if (!empty($reviewImages))
                                                <div class="mt-3">
                                                    <p class="text-xs font-bold uppercase tracking-wide text-black mb-2">
                                                        Hình ảnh đánh giá:</p>
                                            ...
                                            @if ($review->admin_response)
                                                <div class="mt-3 pt-3 border-t border-gray-300">
                                                    <p class="text-xs font-bold uppercase tracking-wide text-black mb-1">
                                                        Phản hồi từ BookBee:</p>
                                                    <p class="text-sm text-gray-600">
                                            ...
                                            <div class="star-rating flex flex-row-reverse justify-end items-center gap-1 quick-star-group"
                                                ...
                                                @for ($i = 5; $i >= 1; $i--)
                                                    <input type="radio"
                                                        ...
                                                        name="rating" value="{{ $i }}" class="sr-only"
                                                        {{ old('rating', 5) == $i ? 'checked' : '' }}>
                                                    <label
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-gray-400 transition-colors"
                                                    ...
                                                    <div class="text-gray-500">
                                                        ...
                                                        <p class="mt-1 text-xs">Kéo thả hoặc <button type="button"
